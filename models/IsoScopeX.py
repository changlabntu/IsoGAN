...
class GAN(BaseModel):
    ...
    def __init__(self, hparams, train_loader, eval_loader, checkpoints):
        ...
        self.upsample = torch.nn.Upsample(size=(hparams.cropsize, hparams.cropsize, hparams.cropz * hparams.uprate))
    ...
    def generation(self, batch):
        z_init = 0 #np.random.randint(batch['img'][0].shape[4] - self.hparams.cropz)
