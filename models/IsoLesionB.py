...
class GAN(BaseModel):
    ...
    def generation(self, batch):
        ...
        gouty = self.net_gy(self.get_xy_plane(self.oriX))
        self.imgXY = gouty['out0']  # (B, C, X, Y, Z)
    ...
    def backward_d(self):
        ...
        dx = self.add_loss_adv(a=Xup, net_d=self.net_d, truth=True)
