...
if 0:
    ...
    #r = transforms.functional.rotate
    #xx = r(x, 45, interpolation=transforms.functional.InterpolationMode.BILINEAR)
    r = transforms.RandomRotation((-45, 45), interpolation=transforms.functional.InterpolationMode.BILINEAR, expand=False, center=None,
                                  fill=0)
    xx = r(x)
    imagesc(xx[10,0,:,:])
...
class GAN(BaseModel):
    ...
    def generation(self, batch):
        ...
        self.rotate = transforms.RandomRotation((-20, 20), interpolation=transforms.functional.InterpolationMode.BILINEAR,
    ...
    def backward_g(self):
        ...
        elif self.hparams.l1scheme == 'oriX':
            loss_l1 = self.add_loss_l1(a=self.XupX[:, :, :, :, ::self.uprate * self.hparams.skipl1],
