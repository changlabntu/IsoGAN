...
class GAN(BaseModel):
    ...
    def generation(self, batch):
        ...
        self.XupX = nn.Tanh()(self.net_g(goutz[-1], method='decode')['out0'])  # X interpolated
        ...
        #self.YupY = nn.Tanh()(self.net_g(self.oriY)['out0'])  # Y interpolated

        # XY masking
        self.XupYmask = nn.Sigmoid()(self.net_g(goutz[-1], method='decode')['out1'])
    ...
    def backward_g(self):
        ...
        return {'sum': loss_g, 'gxx': axx, 'gxy': axy, 'l1': loss_l1, 'l1Y': loss_l1y, 'vgg': loss_gvgg, 'l1Y3d': loss_l1y3d}
