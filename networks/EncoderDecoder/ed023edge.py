...
class Generator(nn.Module):
    def __init__(self, n_channels=1, out_channels=1, nf=32, norm_type='batch', activation=ACTIVATION, final='tanh', mc=False):
        ...
        self.up3 = deconv3d_bn_block(8 * nf, 4 * nf, activation=act, use_upsample=False, kernel=4, stride=2, padding=2)
        ...
        self.up2 = deconv3d_bn_block(4 * nf, 2 * nf, activation=act, use_upsample=False, kernel=4, stride=2, padding=2)
        ...
        self.up1 = deconv3d_bn_block(2 * nf, nf, activation=act, use_upsample=False, kernel=4, stride=2, padding=1)
